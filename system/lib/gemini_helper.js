...
/**
 * Mendapatkan instance GoogleGenAI dengan API Key yang dirotasi.
 * Mendukung env: GEMINI_API_KEYS (koma separated) atau GEMINI_API_KEY (single).
 * @returns {GoogleGenAI} Instance client
 */
export function getGeminiClient() {
    ...
    if (keys.length === 0) {
        throw new Error("GEMINI_API_KEYS not found in .env");
    }
